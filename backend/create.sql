create table tb_movie (id int generated by default as identity, count int, image varchar(255), score float, title varchar(255), primary key (id));
create table tb_score (value float, movie_id int not null, user_id int8 not null, primary key (movie_id, user_id));
create table tb_user (id int generated by default as identity, email varchar(255), primary key (id));
